...
from core.model_context import AgentRunContext
...
def test_cost_aware_assignment(monkeypatch):
    agents = [
        {
            "id": "a1",
            "name": "a1",
            ...
            "capabilities": ["demo"],
            "skills": ["demo"],
            "estimated_cost_per_token": 0.0002,
        ...
        },
        {
            ...
            "capabilities": ["demo"],
            "skills": ["demo"],
            "estimated_cost_per_token": 0.0003,
    ...
    # a1 is filtered due to high load_factor
