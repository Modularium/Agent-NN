...
class TestHybridMatcher(unittest.TestCase):
    def setUp(self):
        ...
        self.matcher = HybridMatcher(
            embedding_size=768, feature_size=64, similarity_threshold=0.7
        )
    ...
    def test_match_task(self):
        ...
        results = self.matcher.match_task(
            self.task_description, self.task_embedding, self.available_agents
        )
    ...
    def test_update_performance(self):
        ...
        self.matcher.update_agent_performance(
            "finance_agent", metrics, success_score=0.9
        )
    ...
    def test_meta_learner_training(self):
        ...
        self.matcher.train_meta_learner(
            task_embeddings, agent_features, success_scores, num_epochs=5
        )
    ...
    def test_score_combination(self):
        ...
        combined = self.matcher._combine_scores(
            similarity, nn_score, "new_agent"  # Agent with no history
        )
        ...
        combined = self.matcher._combine_scores(
            similarity, nn_score, "test_agent"  # Agent with history
        )
    ...
    def test_confidence_calculation(self):
        ...
        confidence = self.matcher._calculate_confidence(
            similarity, nn_score, combined_score
        )
        ...
        confidence_inconsistent = self.matcher._calculate_confidence(0.9, 0.2, 0.5)
    ...
    def test_save_load_state(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            new_matcher = HybridMatcher(embedding_size=768, feature_size=64)
